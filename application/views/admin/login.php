...
<head>
	...
	<title><?php echo get_settings('site_name'); ?> | Login</title>
		...
		<div class="login-header login-caret">
			<div class="login-content">
				<a href="javascript:void(0)" class="logo">
					<img src="<?php echo base_url() ?>assets/admin/images/<?php echo (get_settings('website_logo')!='')?get_settings('website_logo'):'logo@2x.png'; ?>" width="120" alt="" />
				</a>
